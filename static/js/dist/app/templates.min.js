...
function save(e) {
  ...
  (t.name = $("#name").val()),
    ...
    (t.envelope_sender = $("#envelope-sender").val()),
    ...
    $.each($("#attachmentsTable").DataTable().rows().data(), function (e, a) {
      t.attachments.push({
...
function edit(e) {
  ...
  -1 != e
    ? ($("#templateModalLabel").text("Edit Template"),
      ...
      $("#envelope-sender").val(t.envelope_sender),
...
function importEmail() {
  (raw = $("#email_content").val()),
    ...
    raw
      ? api
          .import_email({ content: raw, convert_links: convert_links })
          .success(function (e) {
