...
function deleteCampaign(e) {
  confirm("Delete " + campaigns[e].name + "?") &&
  ...
  return Highcharts.chart(s.elemId, {
    chart: {
      ...
      events: {
        ...
        render: function () {
          this.innerText.attr({ text: s.data[0].count });
        },
      },
    },
    title: { text: s.title },
    ...
    series: [{ data: s.data, colors: s.colors }],
  });
}
function generateStatsPieCharts(e) {
  ...
  $.each(e, function (e, t) {
    $.each(t.stats, function (e, t) {
      if ("total" == e) return (n += t), !0;
      l[e] ? (l[e] += t) : (l[e] = t);
    });
  }),
    $.each(l, function (e, t) {
      if (!(e in statsMapping)) return !0;
      (status_label = statsMapping[e]),
        a.push({ name: status_label, y: Math.floor((t / n) * 100), count: t }),
        a.push({ name: "", y: 100 - Math.floor((t / n) * 100) });
      renderPieChart({
        elemId: e + "_chart",
        title: status_label,
        name: e,
...
function generateTimelineChart(e) {
  ...
  $.each(e, function (e, t) {
    ...
    (t.y = 0),
      ...
      l.push({ campaign_id: t.id, name: t.name, x: a.valueOf(), y: t.y });
  }),
    Highcharts.chart("overview_chart", {
      ...
      plotOptions: {
        series: {
          marker: { enabled: !0, symbol: "circle", radius: 3 },
          cursor: "pointer",
          point: {
            events: {
              click: function (e) {
      ...
      credits: { enabled: !1 },
      series: [{ data: l, color: "#f05b4f", fillOpacity: 0.5 }],
    });
}
$(document).ready(function () {
  Highcharts.setOptions({ global: { useUTC: !1 } }),
    api.campaigns
      ...
      .success(function (e) {
        $("#loading").hide(),
          0 < (campaigns = e.campaigns).length
            ? ($("#dashboard").show(),
              ...
              $.each(campaigns, function (e, t) {
                var a = moment(t.created_date).format(
                ...
                if (moment(t.launch_date).isAfter(moment()))
                  var n =
                    "Scheduled to start: " +
                    moment(t.launch_date).format("MMMM Do YYYY, h:mm:ss a") +
                ...
                campaignRows.push([
                  ...
                  "<div class='pull-right'><a class='btn btn-primary' href='/campaigns/" +
                    t.id +
                    "' data-toggle='tooltip' data-placement='left' title='View Results'>                    <i class='fa fa-bar-chart'></i>                    </a>                    <button class='btn btn-danger' onclick='deleteCampaign(" +
                    e +
